  ...
  return (
    <main className="animated-background flex flex-col justify-center items-center h-screen p-4">
      ...
      <ul className="space-y-4 text-lg">
        ...
        <li>
          <Link href="week-7" className="text-pink-300 hover:text-pink-500">Week 7</Link>
        </li>
        <li>
          <Link href="week-8" className="text-pink-300 hover:text-pink-500">Week 8</Link>
        </li>
        <li>
          <Link href="week-9" className="text-pink-300 hover:text-pink-500">Week 9</Link>
        </li>
        <li>
          <Link href="week-10" className="text-pink-300 hover:text-pink-500">Week 10</Link>
        </li>
      </ul>
    </main>
  );
